...
class ThreadReader(QThread):
    ...
    def __init__(self):
        ...
        self.phase_add = (c_int32  * self.PSHOW_MAX_CHANNEL_NUM)()
        ...
        try:
            while True and not self.stop_flg:
                ...
                if count > 0: # все окей
                    ...
                    #print(self.phase_add)


                    for i in range(len(self.phase_add)):
                        if self.offset_flg:
                            offset.append(self.phase_add[i])
                        else:
                            offset.append(0 * self.phase_add[i])
                   ...
                   # print(offset)
                    ...
                    if  0:  # отладка, что бы повторялась
